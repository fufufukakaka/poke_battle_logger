import {
  ...
  export const FailNotify = () => (
    <Html>
      <Head />
      <Preview>Sorry. We failed to extract battle stats from your battle video.</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>
              Sorry. We failed to extract battle stats from your battle video. Please check the video format and try again or contact us.
            </Text>
            <Text style={paragraph}>
              <ul>

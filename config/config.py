...
POKEMON_TEMPLATE_MATCHING_THRESHOLD = 0.78
...
POKEMON_SELECT_WINDOW_THRESHOLD_VALUE = 200
...
JAPANESE_RANKING_TEMPLATE_PATH = (
    "template_images/japanese_general_templates/ranking.png"
)
